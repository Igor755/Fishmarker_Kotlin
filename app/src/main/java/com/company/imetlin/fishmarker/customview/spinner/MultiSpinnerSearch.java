...
public class MultiSpinnerSearch extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    ...
    public List<DataSpinner> getSelectedItems() {
        List<DataSpinner> selectedItems = new ArrayList<>();
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.spinner_textview_for_spinner, new String[]{spinnerText});
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        MyAdapter(Context context, List<DataSpinner> arrayList) {
        ...
        public Filter getFilter() {
            return new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<DataSpinner>) results.values; // has the filtered values
